                    ...
                    <div class="col-md-8 single-property-content prp-style-1 ">
                            ...
                            <div class="light-slide-item">            
                                <div class="clearfix">
                                    <div class="favorite-and-print">
                                        ...
                                        @php
                                         $user = Auth::user(); 
                                         $rate = App\Models\Rate::where('user_id',$user->id)->where('unit_id',$unit->id)->where('rated',true)->first();
                                        @endphp

                                            @if($rate)                                        
                                            <a class="add-to-fav" href="{{route('unit.rate',$unit->id)}}" id="rate" style=" color: #83CFE5; border: 2px solid #83CFE5;">
                                                <i class="fa fa-star-o" style=" color: #83CFE5;"></i>
                                            </a>                                            
                                             @else
                                            <a class="add-to-fav" href="{{route('unit.rate',$unit->id)}}" id="rate">
                        ...
                        <div class="single-property-wrapper">
                            <div class="single-property-header">                                          
                                <h1 class="property-title pull-left">{{$unit->project->name}} {{$unit->number}}</h1>
                            ...
                            <div class="property-meta entry-meta clearfix ">   
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        ...
                                        <span class="property-info-value">{{$unit->is_sold == 1 ? 'Sold' : 'Available'}}</span>
                                    </span>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        ...
                                        <span class="property-info-value">{{$unit->area_sqft + $unit->project->common_area}} <b class="property-info-unit">Sq Ft</b></span>
                                    </span>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        ...
                                        <span class="property-info-value">{{$unit->project->common_area}} <b class="property-info-unit">Sq Ft</b></span>
                                    </span>
                                </div>
                            ...
                            <div class="section additional-details">
                                ...
                                <ul class="additional-details-list clearfix">
									...
									@endphp
                                        ...
                                        <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">{{$unit->floor->floor == 0 ? 'Ground floor': ordinal($unit->floor->floor). ' Floor'}}</span>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">{{$unit->view}}</span>
                                    </li> 
                                                                       
                                    <li>
                                        <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Direction</span>
                                        <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">{{strtoupper($unit->direction)}}</span>
                                    </li>
									
									<li>
                                        <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Latitude/Longitude</span>
                                        <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">{{$unit->latitude}}/{{$unit->longitude}}</span>
                                    </li>

                                    <li>
                                        <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Current Status</span>
                                        <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">{{ucwords(str_replace('_',' ',$unit->status))}}</span>
                                    </li>



                                    <li>
                                        <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Payment:</span>
                                        <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">{{$unit->payment_plan}}</span>
                                    </li>
                                     @php
			                        ...
			                        @endphp 
                                    <li>
                                        <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Handover:</span>
                                        <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">{{$message}}</span>
                                    </li> 
                            ...
                            <div class="section property-video"> 
                                ...
                                <div class="video-thumb">
                                    <a class="video-popup" href="{{file_exists($unit->video_path) ? $unit->video_path : '#'}}" title="Virtual Tour">
                    ...
                    <div class="col-md-4 p0">
                        <aside class="sidebar sidebar-property blog-asside-right">
                            ...
                            <div class="panel panel-default sidebar-menu wow fadeInRight animated">
                                ...
                                <div class="panel-body recent-property-widget">
                                    @if($setting && $setting->ad_link && $setting->ad_image)
                                    <a href="{{$setting->ad_link}}"><img src="{{URL::to($setting->ad_image)}}"></a>
                                    @else
                                    <a href="#"><img src="{{asset('public/frontend/assets/img/ads.jpg')}}"></a>
                                    @endif
                                </div>
                            </div>
