          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Areas Table</h3><br><button class="btn btn-success btn-sm" style="float: right;"  data-toggle="modal" data-target="#modal-default">Add New</button>
                <!--slider store modal-->
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                         <form class="myareaForm" action="{{route('admin.area.store')}}" method="Post" enctype="multipart/form-data">
                          @csrf
                           ...
                           <div class="form-group">
                             ...
                             <select name="city_id" class="form-control @error('city_id') is-invalid @enderror city_id">
          ...
          @foreach($areas as $area)
                    <tr>
                      <td>{{$area->id}}</td>
                        ...
                        <td>{{$area->seo_title}}</td>
                        @php $keywords = $area->seo_keywords ?? [] @endphp                                           
                        <td>
                        @foreach($keywords as $word)
                        {{$word}},
                        @endforeach
                      </td>                                           
                        <td>{{$area->seo_description}}</td>                                           
                        <td>{{$area->latitude}}</td>                                           
                        <td>{{$area->longitude}}</td>                                           
                        <td><iframe src="{{$area->google_map_location}}" width="400" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></td>                                           
                        <td>{{$area->priority}}</td>                                           
...
<a id="delete" href="{{route('admin.area.delete',$area->id)}}"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="red" class="bi bi-trash-fill" viewBox="0 0 16 16">
