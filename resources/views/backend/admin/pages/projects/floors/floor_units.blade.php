          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Units Table</h3><br><button class="btn btn-success btn-sm" style="float: right;"  data-toggle="modal" data-target="#modal-default">Add New</button>
                <!--Floor unit store modal-->
                          ...
                          @csrf
                           ...
                           <div class="form-group">
                             ...
                             <select class="form-control @error('project_id') is-invalid @enderror projects project_id" name="project_id" >
                              ...
                              <option selected value="{{$floor->project->id}}" {{ old('project_id') == $floor->project->id ? 'selected' : '' }} >{{$floor->project->name}}</option>
