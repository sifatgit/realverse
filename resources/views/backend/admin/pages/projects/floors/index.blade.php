          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Floors Table</h3><br><button class="btn btn-success btn-sm" style="float: right;"  data-toggle="modal" data-target="#modal-default">Add New</button>
                <!--slider store modal-->
...
<a data-toggle="modal" data-target="#modal-default1{{$floor->id}}" href=""><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="skyblue" class="bi bi-pencil-square" viewBox="0 0 16 16">
 ...
 @if ($floor->floor == $topFloors[$floor->project_id])
...
@endif
                ...
                <a id="delete" class="btn btn-danger" href="{{route('admin.floors.delete')}}">Delete all floors.</a>
              </div>
              <!-- /.card-body -->
