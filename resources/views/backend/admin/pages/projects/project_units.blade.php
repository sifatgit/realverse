          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Units Table {{count($units)}} records</h3><br><button class="btn btn-success btn-sm" style="float: right;"  data-toggle="modal" data-target="#modal-default">Add New</button>
                <!--slider store modal-->
                          ...
                          @csrf
                           ...
                           <div class="form-group">
                             ...
                             <select class="form-control @error('project_id') is-invalid @enderror projects project_id" name="project_id" >
                              ...
                              <option selected value="{{$project->id}}" {{ old('project_id') == $project->id ? 'selected' : '' }} >{{$project->name}}</option>
                           ...
                           <div class="form-group">
                             ...
                             <select class="form-control @error('floor_id') is-invalid @enderror floors floor_id" name="floor_id" >
                              ...
                              @foreach(App\Models\Floor::where('project_id',$project->id)->where('floor','>','0')->orderBy('floor','desc')->get() as $floor)
          ...
          @foreach($units as $unit)
                    <tr>
                      <td>{{$unit->id}}</td>
                        ...
                        <td><img src="{{URL::to($images[0])}}" style="width:200px; height:150px;">
                        </td>
