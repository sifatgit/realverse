          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Cities Table</h3><br><button class="btn btn-success btn-sm" style="float: right;"  data-toggle="modal" data-target="#modal-default">Add New</button>
                <!--slider store modal-->
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                         <form class="mycityForm" action="{{route('admin.city.store')}}" method="Post" enctype="multipart/form-data">
                          @csrf
                           ...
                           <div class="form-group">
                             ...
                             <select name="state_id" class="form-control @error('state_id') is-invalid @enderror state_id">
          ...
          @foreach($cities as $city)
                    <tr>
                      <td>{{$city->id}}</td>
                        ...
                        <td>
                        @php $keywords = $city->seo_words ?? []; @endphp
                        @foreach($keywords as $word)
                        {{$word}},
                        @endforeach
                      </td>                                           
                        <td>{{$city->seo_description}}</td>                                           
                        <td>{{$city->latitude}}</td>                                           
                        <td>{{$city->longitude}}</td>                                           
                        <td><iframe src="{{$city->google_map_location}}" width="400" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></td>                                           
                        <td>{{$city->priority}}</td>                                           
...
<a id="delete" href="{{route('admin.city.delete',$city->id)}}"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="red" class="bi bi-trash-fill" viewBox="0 0 16 16">
